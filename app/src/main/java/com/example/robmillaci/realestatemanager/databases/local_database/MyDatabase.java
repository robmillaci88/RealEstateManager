...
public class MyDatabase extends SQLiteOpenHelper{
    ...
    private void createListingsTable(SQLiteDatabase db) {
        String createStatement = "CREATE TABLE IF NOT EXISTS " + ListingsDatabaseContract.TABLE_NAME +
                ...
                ListingsDatabaseContract.STATUS + " TEXT, " +
    ...
    public void getFromLocalDb(Context context, Bundle searchParams, int requestCode) {
        ...
        if (cursor != null && cursor.getCount() >= 1) {
            ...
            cursor.close();
            mPresenter.gotData(databaseListings, requestCode, context.getApplicationContext());
        }
    }
        ...
        Observable.fromIterable(firebaseListings).subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<Listing>() {
                    ...
                    public void onSubscribe(Disposable d) {
                        mDbSyncListener.updateProgressBarSyncProgress(listingCount[0]);
                    }

                    @Override
                    public void onNext(Listing listing) {
                        Log.d("onNext", "onNext: called");
                        listingCount[0]--;
                        mDbSyncListener.updateProgressBarSyncProgress(listingCount[0]);
                    ...
                    public void onError(Throwable e) {
                        mDbSyncListener.syncComplete();
                        Toast.makeText(getApplicationContext(), R.string.sync_timeout, Toast.LENGTH_LONG).show();
                    }
    ...
    public static void addListing(Listing listingToAdd) {
        ...
        if (listingToAdd != null) {
            ...
            //todo try to store all photos in a single field in the database - this isn't really good!
            try {
            ...
            values.put(ListingsDatabaseContract.STATUS, listingToAdd.getAvailable());
    ...
    public interface Model {
        void gotData(ArrayList<Listing> listings, int requestCode, Context c);
    }
